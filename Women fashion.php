...
<body>
  <div class="container">
		...
		<div class="row">
          ...
          <?php
      $res=mysqli_query($link,"select * from products where p_status='1' and category_name='Women fashion' or category_name='women fashion' or category_name='women*' or category_name='Women*'");
