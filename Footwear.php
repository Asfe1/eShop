...
<body>
  <div class="container">
		...
		<div class="row">
          ...
          <?php
      $res=mysqli_query($link,"select * from products where p_status='1' and category_name='Footwear' or category_name='footwear' or category_name='foot*' or category_name='Foot*'");
